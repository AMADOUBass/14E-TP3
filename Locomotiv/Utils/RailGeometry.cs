...
namespace Locomotiv.Utils
{
    ...
    /// Les clés du dictionnaire doivent correspondre à Block.Nom dans la BD (seed).
    /// </summary>
    public static class RailGeometry
    {
        // ======================
        // Points de base (stations & POI)
        // ⚠️ Identiques à ceux du DatabaseSeeder
        // ======================

        public static readonly PointLatLng GareQuebecGatineau =
            new PointLatLng(46.794982825793305, -71.33522613571915);

        public static readonly PointLatLng GareDuPalais =
            new PointLatLng(46.81755933580009, -71.21384802568011);

        public static readonly PointLatLng GareCN =
            new PointLatLng(46.75773740238116, -71.29828246714631);

        public static readonly PointLatLng VersCharlevoix =
            new PointLatLng(46.89513912411967, -71.12869379394515);

        public static readonly PointLatLng BaieDeBeauport =
            new PointLatLng(46.83840691613302, -71.19593518550352);

        public static readonly PointLatLng PortDeQuebec =
            new PointLatLng(46.821717937700434, -71.20669657467614);

        public static readonly PointLatLng CentreDistribution =
            new PointLatLng(46.79312964904228, -71.22721075321274);

        public static readonly PointLatLng VersRiveSud =
            new PointLatLng(46.740152025696275, -71.28218921636818);

        public static readonly PointLatLng VersGatineau =
            new PointLatLng(46.77319899751728, -71.48371966307195);

        public static readonly PointLatLng VersNord =
            new PointLatLng(46.764968551442955, -71.4717033680072);
        ...
        /// </summary>
        public static readonly PointLatLng JonctionEstPalais =
            new PointLatLng(46.8190, -71.2100);

        /// <summary>
        /// Jonction après la Gare CN (bifurcation vers Rive-sud).
        /// </summary>
        public static readonly PointLatLng JonctionCNSud =
            new PointLatLng(46.7500, -71.2900);

        /// <summary>
        /// Jonction entre Québec-Gatineau, Centre de distribution et Rive-sud.
        /// </summary>
        public static readonly PointLatLng JonctionCentre =
            new PointLatLng(46.7850, -71.2650);

        /// <summary>
        /// Jonction ouest de Québec-Gatineau (vers Gatineau / Nord).
        /// </summary>
        public static readonly PointLatLng JonctionOuestGatineauNord =
            new PointLatLng(46.7800, -71.3900);

        // ======================
        // Polylines par nom de block
        // ⚠️ Les clés DOIVENT correspondre exactement à Block.Nom du seed
        // ======================
